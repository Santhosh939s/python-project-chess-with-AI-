...
// Official Staunton / Chess.com Neo Vector Piece Set
const PIECE_SVGS: Record<string, (color: 'w' | 'b') => React.ReactNode> = {
  p: (color) => {
    const isWhite = color === 'w';
    const fillColor = isWhite ? '#ffffff' : '#454545';
    return (
    ...
    return (
      <svg viewBox="0 0 45 45" className="piece-svg">
        ...
        >
          ...
          <path d="M12 14h21l-2 18H13l-2-18z" fill={fillColor} stroke="none" />
          <path
    ...
    return (
      <svg viewBox="0 0 45 45" className="piece-svg">
        <g
          ...
          strokeLinejoin="round"
        >
          <path d="M 22,10 C 32.5,11 38.5,18 38,39 L 15,39 C 15,30 25,32.5 23,18 C 23,11 15,11 15,11 C 0,11 10,24 10,24 C 10,24 13.5,15.5 19,12 C 18,11 16.5,10 16.5,10 C 16.5,10 21,9 22,10 z" />
    ...
    return (
      <svg viewBox="0 0 45 45" className="piece-svg">
        <g
          ...
          strokeLinejoin="round"
        >
          <path d="M22.5 11.63V6M20 8h5" fill="none" stroke="#000000" strokeWidth="1.5" strokeLinejoin="miter" />
          ...
          <path d="M22.5 16.5A4.5 4.5 0 0 0 18 21a4.5 4.5 0 0 0 4.5 4.5A4.5 4.5 0 0 0 27 21a4.5 4.5 0 0 0-4.5-4.5z" fill={fillColor} />
        </g>
      </svg>
    );
  },
...
export default function ChessPiece({ type, color, dragging = false }: Props) {
  ...
  return (
    <div
      className={`piece-container ${color === 'w' ? 'piece-white' : 'piece-black'} ${
